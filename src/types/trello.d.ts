...
export namespace Trello {
    ...
    export interface PowerUp {
        ...
        initialize(handlers: {
            "card-badges": (function(*): *), "board-buttons": ((function(*, *): [{
                condition: string,
                icon: string,
                callback: function ( *,
                *): void, text: string
        }): Trello.PowerUp.Plugin | Trello.PowerUp.IFrame;
        restApiError(): any;
        util: PowerUp.Util;
    }
    ...
    namespace PowerUp {
        ...
        interface HostHandlers extends AnonymousHostHandlers {
            ...
            modal(options: { args: { text: string }, fullscreen: boolean, accentColor: string, callback: (function(): *), title: string, actions: [{ alt: string, position: string, url: string }, { alt: string, callback: (function(*): *), position: string }, { alt: string, callback: (function(): *), position: string }): PromiseLike<void>;
            updateModal(options: {
                accentColor?: string | Colors;
                actions?: HeaderAction[];
                fullscreen?: boolean;
